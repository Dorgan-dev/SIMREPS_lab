                        ...
                        <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                            <div class="error-content">
                                ...
                                <div class="error-actions" data-aos="fade-up" data-aos-delay="800">
                                    ...
                                    <a href="{{ route('home.contact') }}" class="btn-help">
                                ...
                                <div class="error-suggestions" data-aos="fade-up" data-aos-delay="900">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('home') }}"><i class="bi bi-arrow-right-circle"></i> Check our
                                                sitemap</a>
                                        </li>
                                        <li><a href="{{ route('home.contact') }}"><i class="bi bi-arrow-right-circle"></i>
                                                Contact support</a>
                                        </li>
                                        <li><a href="{{ session('prev_url_404') }}">
