                                ...
                                @forelse ($data as $i => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning" item-bs-toggle="modal"
                                                item-bs-target="#editModal{{ $item->res_id }}">
                                                Edit
                                            </button> <!-- Button trigger modal hapus -->
                                            <button type="button" class="btn btn-danger" item-bs-toggle="modal"
                                                item-bs-target="#deleteModal{{ $item->res_id }}">
                                                Hapus
                                            </button>
                                        </td>
                                    </tr>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header bg-primary text-white">
                                                        ...
                                                        <button type="button" class="btn-close btn-close-white"
                                                            item-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            item-bs-dismiss="modal">Tutup</button>
                                    ...
                                    <div class="modal fade" id="deleteModal{{ $item->res_id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <form action="{{ route('reservation.destroy', $item->res_id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="text-danger"><b>Tindakan ini tidak dapat dibatalkan.</b>
                                                        </p>
                                                    </div>

                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            item-bs-dismiss="modal">
                                                            Batal
                                                        </button>
        ...
        <div class="modal-dialog">
            <form action="{{ route('reservation.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" item-bs-dismiss="modal">Tutup</button>
