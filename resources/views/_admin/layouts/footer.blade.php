...
<!-- Page level plugins -->
<script src="{{ asset('_admin/vendor/datatables/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('_admin/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>

<!-- Page level custom scripts -->
<script src="{{ asset('_admin/js/demo/datatables-demo.js') }}"></script>
