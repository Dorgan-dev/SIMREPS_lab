...
<link rel="stylesheet" href="{{ asset('customer/vendor/libs/apex-charts/apex-charts.css') }}" />
...
<!-- Vendors JS -->
<script src="{{ asset('customer/vendor/libs/apex-charts/apexcharts.js') }}"></script>

<!-- Main JS -->
<script src="{{ asset('customer/js/main.js') }}"></script>

<!-- Page JS -->
<script src="{{ asset('customer/js/dashboards-analytics.js') }}"></script>
